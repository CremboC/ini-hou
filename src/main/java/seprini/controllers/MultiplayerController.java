...
public class MultiplayerController extends AircraftController {
	...
	protected void incrementScore(Aircraft aircraft) {
		playerScore[Player.ONE].incrementScore(aircraft.getPoints(Player.ONE)
				* difficulty.getScoreMultiplier());
		playerScore[Player.TWO].incrementScore(aircraft.getPoints(Player.TWO)
				* difficulty.getScoreMultiplier());

		totalScore.incrementScore(aircraft.getPoints(Player.ONE)
				+ aircraft.getPoints(Player.TWO)
				* difficulty.getScoreMultiplier());
	}
